	...
	<script>
		function printAndClose() {
			...
			window.onafterprint = function() {
				window.location.href = '<?= base_url("print_kanban_tmi?tanggal=".$this->input->get("tanggal")); ?>';
			};
		}
    </script>
</head>
<body onload="printAndClose()" >
	...
	if(!empty($data_kanban_print)){
		foreach ($data_kanban_print as $data_kanban_print) {
			...
			if($data_kanban->ed_supplier_name == "ADYAWINSA STAMPING INDUSTRIES"){
